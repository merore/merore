...
call <SID>set_hi("StatusLine", s:fg, s:fg, "NONE")
call <SID>set_hi("StatusLineNC", s:bg, s:bg, "NONE")
...
call <SID>set_hi("SpellBad", s:none, s:none, "NONE")
call <SID>set_hi("SpellCap", s:none, s:none, "NONE")
